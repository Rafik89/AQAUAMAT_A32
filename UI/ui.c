...
//extern uint8_t tmp_var2; // Nie używana zmienna
extern uint8_t year;
...
PROGMEM const char STATUS_MENU_S[] = "";
PROGMEM const char ALARMS_MENU_S[] =  ". Alarmy        \n                ";
PROGMEM const char OUTPUTS_MENU_S[] = ". Wyjscia       \n                ";
PROGMEM const char AD_MENU_S[] =      ". Automatyczna  \n dolewka        ";
PROGMEM const char TEMP_MENU_S[] =    ". Kontrola      \n temperatury    ";
PROGMEM const char TIME_MENU_S[] =    ". Ustawienia    \n czasu          ";
PROGMEM const char TIMERS_MENU_S[] =  ". Timery        \n godzinowe      ";
PROGMEM const char TIMERSV_MENU_S[] = ". Timery        \n interwalowe    ";

PROGMEM const char AD_CLEAR_MENU_S[] = " Czy skasowac   \n alarmy AD?     ";

PROGMEM const char ALARMS_CLEAR_MENU_S[] = "   Czy usunac   \naktywne alarmy? ";
PROGMEM const char ALARMS_BLOCK_MENU_S[] =    " Blokada alarmow";
PROGMEM const char ALARMS_BLOCK_MENU2_S[] =    " Czy zmienic? ";
PROGMEM const char DISCOVER_SENSOR_MENU_S[] = "   Czy wykryc   \n czujniki temp? ";

PGM_P const MENU0_STRS[] PROGMEM =
{
	STATUS_MENU_S,
	ALARMS_MENU_S,
	OUTPUTS_MENU_S,
...
PROGMEM const FuncPtr FuncPtrTable[] = {
